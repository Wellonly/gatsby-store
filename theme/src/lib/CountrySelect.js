...
export default function CountrySelect({label, ...other}) {
  ...
  return (
    <Autocomplete
      ...
      autoHighlight
      getOptionLabel={(option) => `${countryToFlag(option.code)} ${option.name} (${option.code})`}
      renderOption={(option) => (
        <React.Fragment>
...
//renderOption:          {option.name} ({option.code}) +{option.phone}

// From https://bitbucket.org/atlassian/atlaskit-mk-2/raw/4ad0e56649c3e6c973e226b7efaeb28cb240ccb0/packages/core/select/src/data/countries.js
export const countries = [
  { code: 'RU', name: 'Российская федерация', phone: '7' }, /* double in locale */
